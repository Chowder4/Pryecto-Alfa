...
$sql1="SELECT * FROM torneos WHERE nombre ='$_POST[variablenombre_torneo]' and codigo_torneo = $_POST[variablecodigo_torneo]" ;
...
if($num==1){ //Cuando la variable es 1 si que lo puede y cuando es 0 es que no lo puede hacer
